...
<Seo
	...
	seoImage="{$page.url.hostname + $page.url.pathname}/images/pathfinder_wotr.webp"
/>
<!-- Title section -->
<div class="relative">
		...
		<div class="relative m-auto pt-8 px-4 md:pt-16 lg:pt-24 max-w-2xl sm:overflow-hidden">
			<div class="flex items-center justify-center">
				<div class="mr-4 flex-shrink-0">
					<img
						class="h-full w-48 md:w-60 lg:w-72"
						src="/images/pathfinder_wotr.webp"
						alt="Pathfinder Wrath of the Righteous logo"
					/>
				</div>
				<div class="sr-only">
					<h1 class="text-xl lg:text-2xl font-bold dark:text-gray-300">
