<div class="bg-parchament dark:bg-black">
	<main class="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
		<div class="max-w-xl mx-auto py-16 sm:py-24">
			<div class="text-center">
				...
				<h1
					class="mt-2 text-4xl font-extrabold text-gray-900 dark:text-gray-300 tracking-tight sm:text-5xl"
				>
			...
			<div class="mt-12">
				...
				<ul class="mt-4 border-t border-b border-gray-200 divide-y divide-gray-200">
					<li class="relative py-6 flex items-start space-x-4">
						<div class="flex-shrink-0">
							<span class="flex items-center justify-center h-12 w-12 rounded-lg">
								<img class="h-12 w-12" src="/images/bg3.webp" alt="Baldurs Gate 3 logo" />
							</span>
						</div>
						<div class="min-w-0 flex-1">
							<h3 class="text-base font-medium text-gray-900 dark:text-gray-300">
								<span
									class="rounded-sm focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500"
								>
									<a href="/guides/baldurs-gate-3" class="focus:outline-none">
										<span class="absolute inset-0" aria-hidden="true" />
										Baldur's Gate 3 Guides
									</a>
								</span>
							</h3>
							<p class="text-base text-gray-500">Helpful guides for Baldur's Gate 3</p>
						</div>
					...
					<li class="relative py-6 flex items-start space-x-4">
						<div class="flex-shrink-0">
							<span class="flex items-center justify-center h-12 w-12 rounded-lg">
								<img class="h-12 w-12" src="/images/bg1.webp" alt="Baldurs Gate 1 logo" />
							</span>
						</div>
						<div class="min-w-0 flex-1">
							<h3 class="text-base font-medium text-gray-900 dark:text-gray-300">
								<span
									class="rounded-sm focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500"
								>
									<a href="/guides/baldurs-gate-1" class="focus:outline-none">
										<span class="absolute inset-0" aria-hidden="true" />
										Baldur's Gate 1 Guides
									</a>
								</span>
							</h3>
							<p class="text-base text-gray-500">Helpful guides for Baldur's Gate 1</p>
						</div>
						<div class="flex-shrink-0 self-center">
							<!-- Heroicon name: solid/chevron-right -->
							<svg
