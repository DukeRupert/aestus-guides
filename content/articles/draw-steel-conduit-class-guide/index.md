---
title: "Draw Steel Conduit Class Guide: In-Depth Tactical Analysis"
...
This is the second article in a series covering each of the nine base classes in Draw Steel's Heroes book with an in-depth tactical analysis. If you haven't checked it out yet, see my [Censor article](/articles/draw-steel-censor-class-guide/), the first in the series. It has a longer introduction that talks about the series as a whole and what I hope to accomplish. In this article, we're going to keep the intro short.
...
### Recommended Domains: Love + Trickery
